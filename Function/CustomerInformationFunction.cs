...
using AzureFunctionApp.Model.Request.OutboundCustomerInformationRequest;
...
{
    public  class CustomerInformationFunction
    {
        ...
        public CustomerInformationFunction(IConfiguration configuration)
        {
        ...
        [Function("CustomerInformationFunction")]
        public  async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post")] HttpRequestData req,
            FunctionContext executionContext)
        {
            var logger = executionContext.GetLogger(CommonConstant.GetLoggerString);
            logger.LogInformation("C# HTTP trigger function processed a request. CustomerInformationFunction");
            ...
            {
                OutboundCustomerInformationRequest reqData = new OutboundCustomerInformationRequest();
                RequestInput input = new RequestInput();
                input.Interface_ID = "ZSOMI011";
                input.Table_Object = "XD02";
                //input.All_data = "X";// --Fix
                input.All_data = "";//
                ...
                */
                ...
                // Mock
                /*
                List<Sales_OrganizationInput> sales_OrganizationInput = new List<Sales_OrganizationInput>();
                Sales_OrganizationInput so = new Sales_OrganizationInput();
                so.Sales_Organization = "1202";//--Fix
                sales_OrganizationInput.Add(so);
                reqData.Sales_Organization = sales_OrganizationInput;
                */
                //
